...
% E.g 
%       plot_3('multivariate',1,3,0,0.5);
%       plot_3('bivariate',1,3,0,0.5);
%       plot_3('univariate',1,3,0,0.5);

function [] =plot_4(dataset,cost,gamma,coef,nu)
    
    %kernel =  'gaussian';
    if(nargin<5)
        dataset = 'bivariate';
        cost = 1; gamma = 3; coef = 0; nu=0.5;
    end
    eps=0.1;
