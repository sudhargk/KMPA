function out1 = customrands(in1,in2,in3,in4,in5,in6)
...
% $Revision: 1.1.10.6 $  $Date: 2012/08/21 01:04:16 $
...
function w = initialize_input_weight(net,i,j,config)
  C = 0.1;
  fanin = net.inputWeights{i,j}.size(2);
...
function w = initialize_layer_weight(net,i,j,config)
  C = 0.1;
  fanin = net.layerWeights{i,j}.size(2);
